# Cake Eating Problem
https://latex.codecogs.com/png.image?F=P(1+\frac{i}{n})^{nt}
...
<img src="https://render.githubusercontent.com/render/math?math=\large\frac{\partial u}{\partial c}=\frac{\partial v\left(k\right)}{\partial k}">
